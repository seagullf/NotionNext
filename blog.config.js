...
const BLOG = {
  ...
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [17, 6], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'SeaGullf', // 您的昵称 例如 tangly1024
